...
urlpatterns = [
    ...
    path('course/<int:course_id>/attempt-quiz/<int:question_index>/', views.attempt_quiz, name='attempt-quiz'),
    path('course/<int:course_id>/submit-quiz/', views.submit_quiz, name='submit-quiz'),
    path('course/<int:course_id>/quiz-result/<int:student_quiz_id>/', views.quiz_result, name='quiz-result'),
